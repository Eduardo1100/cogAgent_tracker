...
- Agent/eval work:
  ...
  - New branch naming scheme for architecture-improvement rounds: `cogfix-<NN>-<topic>` (e.g. `cogfix-01-exploration-measurement-branch`). Use this for targeted fixes tied to specific experiment post-mortems rather than incremental feature iterations.
